...
<body style="background: linear-gradient(109.76deg, #FFD62E 15.44%, #FFB118 78.39%); background-repeat: none">
	...
	<div class="col-12 " style="height: 100px">
		...
		<div class="col-9 mx-auto" style="height: 600px">
			<div class="col-12 " style="height: 100px; margin-top: 50px">
			<h1 style="font-size: 65px">Помощь</h1>
			<hr class="bg-dark" style="width: 250px; height:10px; margin-left: 0px ">
			</div>
			<div class="col-12" style="height: 100px; margin-top: 50px">
				<div class="row">
					<div>
						<h1 style="font-size: 30px">Горячая линия:</h1>
					</div>
					<div>
						<img src="8.png">
					</div>
					<div >
						<h1 style="font-size: 30px">+7944443333</h1>
					</div>
				</div>
			</div>
			<div class="col-12">
				<div class=" border: solid black" style="width: 550px;  margin-top: 50px; border-radius : 0px 30px 30px 20px;
			border-style: solid; border-width: 10px ;border-radius : 0px 30px 30px 20px; box-shadow: 0px 5px 20px 0px red; background-color: #FF3E3E">
				<a href="" style="text-decoration: none; ">
					<h1 class="text-light" style="font-size: 35px">
						Часто задаваемые вопросы
					</h1>
				</a>
			</div><div class=" border: solid black" style="width: 550px;  margin-top: 50px; border-radius : 0px 30px 30px 20px;
			border-style: solid; border-width: 10px ;border-radius : 0px 30px 30px 20px; box-shadow: 0px 5px 20px 0px red; background-color: #FF3E3E">
				<a href="" style="text-decoration: none; ">
					<h1 class="text-light" style="font-size: 35px">
						Спросить у поддержки в чате
					</h1>
				</a>
			</div>
			</div>
